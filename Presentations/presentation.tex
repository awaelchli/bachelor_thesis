...
\begin{frame}[fragile]
	...
	\begin{center}
		\input{figures/spectral_support/epi_two_objects.tex}
		\hspace{1cm}
		\only<1>{\input{figures/spectral_support/epi_fourier_transform.tex}}
		\only<2>{\input{figures/spectral_support/fourier_transform_red_and_blue.tex}}
	\end{center}
\end{frame}
