...
\begin{frame}[fragile]
	...
	\end{itemize}
	\begin{center}
		\only<3>{\input{figures/two-plane-parameterization.tex}}
	\end{center}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{center}
		\only<1,2>{\includegraphics[width = 4cm]{images/stanford_camera_array_2.jpg}}
		\hspace{1cm}
		\only<2>{\includegraphics[width = 4cm]{images/Lytro_Light_Field_Camera-front_background_removed.png}}
	\end{center}
