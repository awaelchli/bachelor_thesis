...
\begin{frame}[fragile]
	...
	\begin{figure}
		\subcaptionbox*{Original}{\includegraphics[width=4cm]{figures/tiling/original_08_08}}
		\hspace{1cm}
		\subcaptionbox*{Simulation}{\includegraphics[width=4cm]{figures/tiling/tarot_tiles3x3x200x200_no_overlap_3_layers/Reconstruction_of_view_(3,3).png}}
	\end{figure}
...
\begin{frame}[fragile]
	...
	\begin{figure}
		\subcaptionbox*{No overlap}{\includegraphics[width=4cm]{figures/tiling/tarot_tiles3x3x200x200_no_overlap_3_layers/Reconstruction_of_view_(3,3).png}}
		\hspace{1cm}
		\subcaptionbox*{30\% overlap}{\includegraphics[width=4cm]{figures/tiling/tarot_tiles5x5x200x200_overlap0.5_3_layers/Reconstruction_of_view_(3,3).png}}
	\end{figure}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{figure}
		\subcaptionbox*{Original}{\includegraphics[height=4cm]{figures/depth_of_field/original_08_08}}
		\hspace{1cm}
		\subcaptionbox*{16 mm thick}{\includegraphics[height=4cm]{figures/depth_of_field/knights_thickness_16mm/Reconstruction_of_view_(5,5)}}
	\end{figure}
...
\begin{frame}[fragile]
	...
	\begin{figure}
		\subcaptionbox*{Original}{\includegraphics[height=4cm]{figures/depth_of_field/original_08_08}}
		\hspace{1cm}
		\subcaptionbox*{30 mm thick}{\includegraphics[height=4cm]{figures/depth_of_field/knights_thickness_30mm/Reconstruction_of_view_(5,5)}}
	\end{figure}
