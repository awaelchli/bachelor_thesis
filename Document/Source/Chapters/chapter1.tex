...
\begin{figure}[tb]
	\subfigure[Image courtesy D-Kuru/Wikimedia Commons]{
		\includegraphics[height = 4cm]{../Figures/lytro/Lytro_Light_Field_Camera-front_background_removed}
		\label{fig:lytro_camera}
	}
	\hfill
	\subfigure[]{
		\includegraphics[height = 4cm]{../Figures/camera_array/stanford_camera_array_2}
...
In their paper, they present a model for a inexpensive 3D display built from light attenuating, multiplicative masks.
...
The idea for this thesis is to extend the work of \citeauthor{WetzsteinTomo} to support camera light fields (e.g. captured with a Lytro camera) in addition.