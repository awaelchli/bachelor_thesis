...
\begin{figure}[tb]
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[height = 3cm]{../Figures/depth_compression/baseline_unscaled/Reconstruction_of_view_(9,9).png}
		\caption{}
		\label{fig:reconstruction_baseline_unscaled}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\includegraphics[height = 3cm]{../Figures/depth_compression/baseline_scaled_shifted/Reconstruction_of_view_(9,9).png}
		\caption{}
