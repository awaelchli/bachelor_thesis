...
\begin{figure}[t]
	\centering
	\subcaptionbox*{Original ray density (same as light field)}{
		\adjustbox{width = 0.3\textwidth, trim={0.15\width} {0.2\height} {0.15\width} {0.15\height}, clip}{\includegraphics{../Figures/oversampling/density_1/1.png}}
		\adjustbox{width = 0.3\textwidth, trim={0.15\width} {0.2\height} {0.15\width} {0.15\height}, clip}{\includegraphics{../Figures/oversampling/density_1/3.png}}
		\adjustbox{width = 0.3\textwidth, trim={0.15\width} {0.2\height} {0.15\width} {0.15\height}, clip}{\includegraphics{../Figures/oversampling/density_1/5.png}}
	}\hfill%
	
	\vspace{0.15cm}
	
	\subcaptionbox*{5x ray density in spatial dimensions}{
		\adjustbox{width = 0.3\textwidth, trim={0.15\width} {0.2\height} {0.15\width} {0.15\height}, clip}{\includegraphics{../Figures/oversampling/density_5/1.png}}
		\adjustbox{width = 0.3\textwidth, trim={0.15\width} {0.2\height} {0.15\width} {0.15\height}, clip}{\includegraphics{../Figures/oversampling/density_5/3.png}}
		\adjustbox{width = 0.3\textwidth, trim={0.15\width} {0.2\height} {0.15\width} {0.15\height}, clip}{\includegraphics{../Figures/oversampling/density_5/5.png}}
	}\hfill%
	...
	\caption[Impact of oversampling on attenuation layers and reconstruction error]
			{Impact of oversampling on attenuation layers and reconstruction error.
			 Three of five layers (bottom most, middle, topmost) are shown and compared for different sampling densities.
			 Below, the RMSE of the reconstructed light field is plotted for an increasing sampling density.}
