...
%
% talk about sampling directly from layers
%
The final method implemented in this thesis introduces a new virtual plane that is parallel to the attenuation layers but can be placed at any distance.
