...
\end{figure}
%It shows that the quality measured by the \mbox{PSNR} increases with more layers added to the display, but above five layers, there seems to be not much of a benefit.
