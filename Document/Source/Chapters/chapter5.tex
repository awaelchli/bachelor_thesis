...
The software together with the GUI is available as an executable\footnote{The software is available at \url{https://github.com/awaelchli/bachelor_project}.} 
