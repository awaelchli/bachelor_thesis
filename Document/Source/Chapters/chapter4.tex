...
It turns out to be quite hard to analytically derive an expression for the upper bound.
\cite{WetzsteinTomo} present a geometric approach and give an approximation
