...
A signal with a period smaller than two pixels can not be reproduced by the layer and thus, the spatial cutoff frequency is defined as $\xi_0 = \frac{1}{2p}$ cycles/m.
...
\begin{figure}[tb]
	...
	\subfigure[]{
		...
		\label{fig:spectral_support_3_layers_white_noise}
	}
	\hfill
	\subfigure[]{
		\includegraphics[height = 3cm]{../Figures/spectral_support/convolution_6_layers}
		\label{fig:spectral_support_6_layers_white_noise}
	}
	\caption[Spectral support of layered 3D displays]
			{Spectral support of layered 3D displays. 
			 ...
			 (c) Magnitude response of the convolution scaled logarithmically.
			 (d) ...}
\end{figure}
