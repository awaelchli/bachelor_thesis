...
\begin{figure}[tb]
	\subcaptionbox{\label{fig:all_three_backlights}}{\includegraphics[scale = 0.3]{placeholder}}\hfill%
	\subcaptionbox{\label{fig:look_inside_backlight_1}}{\includegraphics[scale = 0.3]{placeholder}}\hfill%
	\subcaptionbox{\label{fig:look_inside_backlight_2}}{\includegraphics[scale = 0.3]{placeholder}}
